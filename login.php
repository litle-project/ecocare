					...
					<div class="col-sm-4 col-sm-offset-4">
						<div class="login box">
							...
							<div class="box-content">
								<form action="http://cms.pistarlabs.net/index.php/login" method="post" accept-charset="utf-8">
									...
									<div class="form-group">
										...
										<input type="password" name="password" value="" placeholder="Your Password" class="col-xs-12 form-control" />
									</div>
