								...
								<table class="table table-striped table-bordered table-hover display">
									...
									?>
										<tr class="gradeX">
											...
											<td>
												<input type="number" readonly name="<?php echo"package_price".$package[$i]["package_id"]?>" class="form-control" id="<?php echo "package_price".$package[$i]["package_id"]?>" value="<?php echo $package[$i]['price']?>"/>
											</td>
											<td><a href="<?php echo base_url("schedule_mrur/detail_request?package_id=".$package[$i]['package_id']."&schedule_type=".$data[0]['schedule_type']."&contract_id=".$data[0]['contract_id']."&contract_schedule_id=".$data[0]['contract_schedule_id'])?>" class="btn btn-sm btn-fill btn-primary">Detail Request</a></td>
										</tr> 
									<?php $no++; }?>
									</tbody>
								</table>
