			...
			<div class="row">
				<div class="form-body col-md-12">
                    <div class="form-group">
						...
						<div class="col-md-10">
							<div class="col-md-10">
								<input type="text" class="form-control" placeholder="Select Request Date" name="request_date" readonly id="datepicker1" required/>
							</div>
						</div>
					</div>
                    					<!-- start teknisi div -->
							...
							<table class="table table-striped table-bordered table-hover display">
								...
								?>
									<tr class="gradeX">
										...
										<td>
											<?php 
												echo form_input("package_qty".$package[$i]["package_id"],"","class='form-control' id='package".$package[$i]["package_id"]."' required='required' disabled");	
											?>
										</td>
									</tr>
								<?php $no++; } ?>
