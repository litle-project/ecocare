<div class="row">
	...
	<div class="col-md-12 col-sm-12">
							...
							?>
								<tr class="gradeX">
									...
									<td>
										...
										<input name="request_qty" value="<?php echo $row["product_qty"];?>" type="number" min="0" max="" class='form-control' required>
									</td>
									<td>
		...
		<div class="form-actions fluid col-md-12">
			<center>
				<button type="reset" class="btn black" onclick="window.location.href='<?php echo base_url("contract_request")?>';"  id="reset"><b>Back</b></button>
			</center>
		</div>
	</div>
</div>
