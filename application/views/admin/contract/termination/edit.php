<div class="row">
	<div class="col-lg-12 col-md-12">
		...
		<div class="col-lg-5 col-md-5 col-sm-5">
			<ul class="breadcrumb pull-right">
				<li>
					<a href="#" onclick="window.location.href='<?php echo site_url($this->uri->segment(1));?>'">Manage Contract Special Request</a>
				</li>
				<li>
	...
	<div class="col-md-12 col-sm-12">
							...
							?>
								<tr class="gradeX">
									...
									<td>
										...
										<input name="product_qty" value="<?php echo $row["product_qty"];?>" type="number" min="0" max="" class='form-control' required>
									</td>
									<td>
				...
				<div class="portlet box grey">
					<div class="portlet-body">										
						<table class="table table-striped table-bordered table-hover display">
							...
							?>
								<tr class="gradeX">
									<form action="<?php echo site_url($this->uri->segment(1)."/update_package_qty/".$key['contract_schedule_detail_id']."")?>" method="post">
									<td><?php echo $no;?></td>
									<td><?php echo $key['package_name']?></td>
									<td>
										<input type="hidden" name="contract_schedule_id" value="<?php echo $package[0]['contract_schedule_id'];?>">
										<input name="package_qty" value="<?php echo $key["package_qty"];?>" type="number" min="0" max="" class='form-control' required>
									</td>
									<td>
										<button type="submit" class="btn blue"><b>Update</b></button>
									</td>
		...
		<div class="form-actions fluid col-md-12">
			<center>
				<button type="reset" class="btn black" onclick="window.location.href='<?php echo base_url("contract_termination")?>';"  id="reset"><b>Back</b></button>
			</center>
		</div>
	</div>
</div>
