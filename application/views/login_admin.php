						...
						<div class="login box">
							...
							<div class="box-content">
                                ...
                                <div class="form-group">
									...
									<input type="text" name="username" value="admin" placeholder="Your username" class="col-xs-12 form-control" />
								</div>
								<div class="form-group">
									<label for="password">Password</label>
									<input type="password" name="password" value="123456" placeholder="Your password" class="col-xs-12 form-control" />
								</div>
