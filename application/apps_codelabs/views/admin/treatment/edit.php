						...
						<form action="" method="post" class="form-horizontal" enctype='multipart/form-data'>
							<div class="form-body">
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control" name="treatment_code" value="<?php echo $row["treatment_code"];?>" placeholder="Treatment Code" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<?php
											echo form_dropdown("treatment_category_id",$treatment_category,$row["treatment_category_id"],'class="form-control" required');
										?>
									</div>
								</div>
