						...
						<form action="" method="post" class="form-horizontal" enctype='multipart/form-data'>
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<?php
											echo form_dropdown("level_id",$level,"","class='form-control' required");
										?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control" name="stylist_price" value="" placeholder="Treatment Price" required>
